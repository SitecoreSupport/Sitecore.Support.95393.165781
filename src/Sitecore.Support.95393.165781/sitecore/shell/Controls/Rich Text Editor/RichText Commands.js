...
function scInsertSitecoreLink(sender, returnValue) {
    ...
    //Start of the modification for the patch #95393
    ...
    //End of the modification for the patch #95393
    ...
    if (text == "" || text == null || ((text != null) && (text.length == 15) && (text.substring(2, 15).toLowerCase() == "<p>&nbsp;</p>"))) {
        ...
        if (match && match.length >= 2) {
            //Start of the modification for the patch #165781
            var linkToPaste = "<a ";
            ...
            //End of the modification for the patch #165781
            return;
        }
    }
